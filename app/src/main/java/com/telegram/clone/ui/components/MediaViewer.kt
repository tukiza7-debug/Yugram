 ...
 * media is not yet available locally. Gallery saving goes through the
 * shared [com.telegram.clone.core.util.GallerySaver].
 */
@Composable
fun FullscreenMediaViewer(
    ...
    LaunchedEffect(pendingSave) {
        ...
        saving = true
        val message = com.telegram.clone.core.util.GallerySaver.saveToGallery(
            context = context,
