...
Pre-built debug APKs are published on the **[Releases](../../releases/latest)** page. Grab the latest `Yugram-*.apk`, install it on your device, and sign in with your Telegram account.

> The APK is a **debug build**. Enable "Install from unknown sources" on your device before installing.
